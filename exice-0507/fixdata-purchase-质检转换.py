...
filename = "d:\\tmp\\2405H-S135-CA03.xlsx"
tmpfile = "d:\\tmp\\tmp.txt"
...
for row in sheet.iter_rows(min_row=2, max_row=sheet.max_row, values_only=True):
    ...
    for sku in skuList:
        ...
        sku["inTransitQty"] = qty-cur_qty
        sku["totalQty"] = 0
    # req_exam = json.dumps(req_exam)
    print(req_exam)
    #发送POST请求

    response = requests.post(api_list["stock_log_url"], json=req_exam, headers=headers)
    print(response.text)
    # 检查响应状态码
